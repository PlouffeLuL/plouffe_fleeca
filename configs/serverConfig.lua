...
if GetConvar("plouffe_fleeca:gabzmap", "") == "true" then
  Fle.Banks = {
    ...
    fleeca_centreville = {
      ...
      trolleySpawns = {
        entry = {
          coords = vector3(-350.78731079102, -54.274928283691, 48.009525299072),
          rotation = vector3(0.0, -0.0, 162.3)
        },
        back = {
          isExtra = true,
          coords = vector3(-352.49783935547, -59.723039245605, 48.009525299072),
          rotation = vector3(0.0, -0.0, -19.7)
        },
        side = {
          isExtra = true,
          coords = vector3(-353.46096191406, -57.328311157227, 48.009525299072),
          rotation = vector3(0.0, -0.0, -108.6)
        }
      },
    ...
    fleeca_vescpucci = {
      ...
      trolleySpawns = {
        entry = {
          coords = vector3(-1209.4291748047, -333.5642944336, 36.753974914551),
          rotation = vector3(0.0, -0.0, -153.0)
        },
        back = {
          isExtra = true,
          coords = vector3(-1206.6458740234, -338.54390869141, 36.753974914551),
          rotation = vector3(0.0, -0.0, 27.2)
        },
        side = {
          isExtra = true,
          coords = vector3(-1209.184765625, -337.57776489258, 36.753974914551),
          rotation = vector3(0.0, -0.0, -64.200000000001)
        }
      },
    ...
    fleeca_beach = {
      ...
      trolleySpawns = {
        entry = {
          coords = vector3(-2958.4331054688, 484.37628173828, 14.669975280762),
          rotation = vector3(0.0, -0.0, -91.199999999999)
        },
        back = {
          isExtra = true,
          coords = vector3(-2952.8749511719, 484.30908813477, 14.669975280762),
          rotation = vector3(-0.0, -0.0, 87.999999999999)
        },
        side = {
          isExtra = true,
          coords = vector3(-2954.775, 482.67637329102, 14.669975280762),
          rotation = vector3(0.0, -0.0, -2.6)
        }
      },
    ...
    fleeca_sandy = {
      ...
      trolleySpawns = {
        entry = {
          coords = vector3(1173.5650878906, 2710.8947753906, 37.060886383057),
          rotation = vector3(0.0, -0.0, 0.0)
        },
        back = {
          isExtra = true,
          coords = vector3(1173.2752734375, 2716.6168261719, 37.060886383057),
          rotation = vector3(0.0, -0.0, 179.95)
        },
        side = {
          isExtra = true,
          coords = vector3(1175.2039550781, 2714.3137695312, 37.060901641846),
          rotation = vector3(0.0, -0.0, 90.099999999999)
        }
      },
